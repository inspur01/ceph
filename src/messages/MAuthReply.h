...
// struct MGrantReply : public Message {
//   __u32 protocol;
//   __s32 result;
//   uint64_t global_id;      // if zero, meaningless
//   string result_msg;
...
//   MGrantReply() : Message(CEPH_MSG_AUTH_REPLY), protocol(0), result(0), global_id(0) {}
//   MGrantReply(__u32 p, bufferlist *bl = NULL, int r = 0, uint64_t gid=0, const char *msg = "") :
//     Message(CEPH_MSG_AUTH_REPLY),
//     protocol(p), result(r), global_id(gid),
//     result_msg(msg) {
//     if (bl)

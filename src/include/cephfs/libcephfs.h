...
int ceph_get_work_id(struct ceph_mount_info *cmount, int fd, int *work_id);

int ceph_set_work_id(struct ceph_mount_info *cmount, int fd, int work_id);
...
int ceph_get_user_quota(struct ceph_mount_info *cmount, uid_t uid,gid_t gid,
	        uint64_t *hard, uint64_t *soft, uint64_t *used);

int ceph_get_dir_quota(struct ceph_mount_info *cmount, const char *path, struct statvfs *stbuf);

...
public:
  ...
  /* Get the MsStatusCollection of this CephContext */
  MsStatusCollection *get_msstatus_collection();
...
private:
  ...
  /* The collection of ms connection status with this context */
  MsStatusCollection *_ms_status_collection;

...
class MClientGetUid;//zzg
class MClientUidReply;//zzg
...
public:
  ...
  int get_clientuid(string username, string passwd, int bauth); //zzg
  void handle_clientuid_reply(MClientUidReply* m);//zzg

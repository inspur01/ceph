...
public:
  ...
  static const  float full_ratio_uplimit = 0.97;
  static const  float nearfull_ratio_uplimit = 0.87;
  float full_ratio;
 ...
 public:
  ...
  void set_full_ratios(float full, float nearfull) {
    if (full_ratio == full && nearfull_ratio == nearfull)
      return;
    full_ratio = full > full_ratio_uplimit ? full_ratio_uplimit : full;
    nearfull_ratio = nearfull > nearfull_ratio_uplimit ? nearfull_ratio_uplimit : nearfull;
    redo_full_sets();
  }

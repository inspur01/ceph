...
std::string LogEvent::get_type_str() const
{
  ...
  case EVENT_USER_QUOTA: return "USERQUOTA";
  case EVENT_USER_FILE_QUOTA: return "USERFILEQUOTA";
  case EVENT_GRP_QUOTA: return "GRPQUOTA";
  case EVENT_GRP_FILE_QUOTA: return "GRPFILEQUOTA";
  case EVENT_DIR_QUOTA: return "DIRQUOTA";
...
LogEvent::EventType LogEvent::str_to_type(std::string const &str)
{
  ...
  types["USERQUOTA"] = EVENT_USER_QUOTA;
  types["USERFILEQUOTA"] = EVENT_USER_FILE_QUOTA;
  types["GRPQUOTA"] = EVENT_GRP_QUOTA;
  types["GRPFILEQUOTA"] = EVENT_GRP_FILE_QUOTA;
  types["DIRQUOTA"] = EVENT_DIR_QUOTA;
...
LogEvent *LogEvent::decode_event(bufferlist& bl, bufferlist::iterator& p, LogEvent::EventType type)
{
  ...
  case EVENT_USER_QUOTA: le = new EUserQuota; break;
  case EVENT_USER_FILE_QUOTA: le = new EUserFileQuota; break;
  
  case EVENT_GRP_QUOTA: le = new EGrpQuota; break;
  case EVENT_GRP_FILE_QUOTA: le = new EGrpFileQuota; break;

  case EVENT_DIR_QUOTA: le = new EDirQuota; break;

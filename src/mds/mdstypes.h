...
#define MDS_INO_USER_QUOTA        101
#define MDS_INO_GRP_QUOTA         102
#define MDS_INO_FILE_QUOTA        103
#define MDS_INO_DIR_QUOTA         104
...
struct quota_info_t
{
  ...
  bool is_valid() const {
    return max_Gbytes >=0 && max_files >=0;
  }
  bool is_enable() const {
    return max_Gbytes || max_files;
  }
};

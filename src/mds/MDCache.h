...
class MDCache {
 public:
  ...
  xlist<CDir*> complete_readahead_dirs;
  void del_complete_readahead_dir(client_t client);
  void add_complete_readahead_dir(CDir* dir);
...
public:
 ...
 public:
  ...
  void dump_cache_inoidx(const char *fn=0);
  ...
  void fetch_quota();
  void fetch_user_quota();
  void fetch_grp_quota();
  void fetch_file_quota();
  void fetch_grp_used_quota();
  void store_quota();

  void fetch_dir_quota();
  void store_dir_quota();
};

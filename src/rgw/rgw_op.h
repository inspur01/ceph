...
public:
  RGWOp() : s(NULL), dialect_handler(NULL), store(NULL), cors_exist(false), op_ret(0) {}
  virtual ~RGWOp() {}
  ...
  //virtual int check_metadata_deal_num() = 0;

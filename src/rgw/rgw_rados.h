...
public:
  ...
  string get_obj_manifest_prefix(){
     return prefix;
  }
...
public:
  ...
  public:
    SystemObject(RGWRados *_store, RGWRadosCtx& _ctx, rgw_obj& _obj) : store(_store), ctx(_ctx), obj(_obj), state(NULL) {}

    RGWRados *get_store() { return store; }
    rgw_obj& get_obj() { return obj; }
    RGWRadosCtx& get_ctx() { return ctx; }
  ...
  virtual int stat_system_obj(RGWRadosCtx& obj_ctx,
  ...
  virtual int get_system_obj(RGWRadosCtx& obj_ctx, RGWRados::SystemObject::Read::GetObjState& read_state,
 ...
 */
  ...
  int apply_olh_log(RGWRadosCtx& ctx, RGWObjState& obj_state, RGWBucketInfo& bucket_info, rgw_obj& obj,
  ...
  int update_olh(RGWRadosCtx& obj_ctx, RGWObjState *state, RGWBucketInfo& bucket_info, rgw_obj& obj);
  ...
  int follow_olh(RGWRadosCtx& ctx, RGWObjState *state, rgw_obj& olh_obj, rgw_obj *target);

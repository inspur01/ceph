...
#define XIO_DISORDER_MSG_DEPTH 256
...
private:
  ...
  int q_high_mark;
  int q_low_mark;
  map<unsigned, Message *>msg_map; // disorder msg map
...
public:
  ...
  int on_msg_req2(XioDispatchHook *m_hook);
  ...
  void flush_disorder_msg(XioMessenger *msgr);
};

...
public:
 ...
 public:
  ...
  struct Scrubber {
    ...
    static const char *state_string(const PG::Scrubber::State& state) {
      ...
      switch( state )
      {
        ...
        case ASK_REPLICAS: ret = "ASK_REPLICAS"; break;
        ...
        case CHECK_CHUNK_WRITE: ret = "CHECK_CHUNK_WRITE"; break;
  ...
  // -- flush --
  struct Flusher{
    utime_t flush_reg_stamp;  // stamp we registered for
  }flusher;
...
public:
  ...
  virtual bool agent_choose_mode_tick(PG *pg) = 0;//add by yutao at 20141208 for cachepool periodical flush
};
